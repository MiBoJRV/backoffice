import{r as l,j as e,R as oe}from"./react-e4f9e9db.js";import{c as ze}from"./react-dom-0329b42b.js";import{s as g}from"./styled-components-1bb8b538.js";import{t as Ge}from"./react-datepicker-25259f22.js";import{C as K,a as ae,b as re,P as ie,c as le,p as ce,d as Y,e as V,A as Pe}from"./chart.js-bfe8637c.js";import{L as de,D as Le}from"./react-chartjs-2-6e669065.js";import{L as Re,c as Be,R as Me}from"./react-router-dom-da031170.js";import{f as he,c as G,O as Z}from"./react-router-1f7ddfb2.js";import"./classnames-3ea37277.js";import"./scheduler-765c72db.js";import"./tslib-e256ba82.js";import"./@emotion-019a61c4.js";import"./stylis-bbc0ab72.js";import"./date-fns-c3a66ad6.js";import"./@babel-e65c6041.js";import"./react-onclickoutside-cb430245.js";import"./react-popper-3956628d.js";import"./react-fast-compare-399d5c84.js";import"./@popperjs-f3391c26.js";import"./warning-df10c181.js";import"./@kurkle-b1b89bbc.js";import"./@remix-run-e2fd8c25.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function i(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(s){if(s.ep)return;s.ep=!0;const a=i(s);fetch(s.href,a)}})();const pe=l.createContext(),_e=({children:t})=>{const[n,i]=l.useState(localStorage.getItem("accessToken")||null),[o,s]=l.useState(localStorage.getItem("userRole")||null),a=(c,h)=>{i(c),s(h),localStorage.setItem("accessToken",c),localStorage.setItem("userRole",h)},r=()=>{i(null),s(null),localStorage.removeItem("accessToken"),localStorage.removeItem("userRole")};return e.jsxs(pe.Provider,{value:{accessToken:n,userRole:o,login:a,logout:r},children:[" ",t]})},xe=()=>l.useContext(pe),$e=g.div`
  border-radius: 10px;
  background: #FFF;
...
`;g.div`
`;g.div`
`;const Qe=({accessToken:t})=>{const{customers:n,pageSize:i,setPageSize:o,currentPage:s,setCurrentPage:a,totalPages:r,searchTerm:c,setSearchTerm:h,handlePageChange:d,selectedDate:u,handleDateChange:m,fetchCustomers:j}=Ue(t),p=(s-1)*i+1,k=Math.min(p+i-1,n.length),y=n.length,v=()=>{s>1&&a(s-1)},F=()=>{s<r&&a(s+1)},[f,N]=l.useState(!1),x=()=>{N(!0)},w=()=>{N(!1)},C=b=>{j()},I=()=>{const b=new Date;return new Date(b.getUTCFullYear(),b.getUTCMonth(),b.getUTCDate())},[T,z]=l.useState(!1),[P,A]=l.useState(null),{handleUpdateCustomer:E,error:S}=Ye(j),B=async b=>{await E(b),z(!1)},[Ne,Ee]=l.useState(!1),[ee,Te]=l.useState(null),Ie=b=>{Te(b.id),Ee(!0),console.log(b.id)};return Ne&&ee?e.jsx(he,{to:`/admin/customer?id=${ee}`}):e.jsxs(Ze,{children:[e.jsxs("div",{className:"table-control",children:[e.jsxs("div",{className:"search",children:[e.jsx("img",{className:"search-icon",src:Ve,alt:"icon"}),e.jsx("input",{type:"text",placeholder:"Search...",value:c,onChange:b=>h(b.target.value)})]}),e.jsxs("div",{className:"date-filter",children:[e.jsx(Ge,{selected:u||I(),onChange:m,dateFormat:"dd.MM.yyyy"}),e.jsx("img",{className:"data-icon",src:W,alt:"icon"})]}),e.jsx("div",{className:"create-new",children:e.jsx("button",{onClick:x,children:"Create"})})]}),e.jsxs("div",{className:"table-size",children:["Show",e.jsxs("select",{value:i,onChange:b=>o(b.target.value),children:[e.jsx("option",{value:"10",children:"10"}),e.jsx("option",{value:"25",children:"25"}),e.jsx("option",{value:"50",children:"50"}),e.jsx("option",{value:"100",children:"100"})]}),"entries"]}),e.jsx("div",{className:"table-info",children:e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:" ID"}),e.jsx("th",{children:"Name"}),e.jsx("th",{children:"Email"}),e.jsx("th",{children:"Phone Number"}),e.jsx("th",{children:"Case Number"}),e.jsx("th",{children:"Recovered Amount"}),e.jsx("th",{children:"Date"}),e.jsx("th",{})]})}),e.jsx("tbody",{children:n.map(b=>e.jsxs("tr",{children:[e.jsx("td",{children:b.numericId}),e.jsxs("td",{children:[b.firstName," ",b.lastName]}),e.jsx("td",{children:b.email}),e.jsx("td",{children:b.phone}),e.jsx("td",{children:b.caseNumber}),e.jsx("td",{children:b.totalWorth}),e.jsx("td",{children:b.caseStarted}),e.jsx("td",{children:e.jsx("img",{className:"edit",src:U,alt:"icon",onClick:()=>{Ie(b)}})})]},b.id))})]})}),e.jsxs("div",{className:"table-entries",children:[e.jsxs("p",{children:["Showing ",p," to ",k," of ",y," entries"]}),e.jsxs("div",{className:"table-pages",children:[r>1&&e.jsx("button",{onClick:v,disabled:s===1,children:e.jsx("img",{className:"page-icon",src:ue,alt:"icon"})}),e.jsx("span",{className:"page",children:s}),r>1&&e.jsx("button",{onClick:F,disabled:s===r,children:e.jsx("img",{className:"page-icon",src:ge,alt:"icon"})})]})]}),T&&P&&e.jsx(L,{isOpen:T,onClose:()=>z(!1),children:e.jsx(me,{customer:P,onSave:B})}),f&&e.jsx(L,{isOpen:f,onClose:()=>N(!1),children:e.jsx(Je,{isOpen:f,onClose:w,onCreate:C})})]})},Xe=()=>e.jsx($e,{children:e.jsx(Qe,{})}),De=g.div`
  width: 100%;
...
`,et=()=>{const t=G();return l.useEffect(()=>{const n=localStorage.getItem("accessToken"),i=localStorage.getItem("userRole");n||t("/login"),i!=="Admin"&&t("/login")},[t]),e.jsx(De,{children:e.jsx("div",{className:"dashboard_content",children:e.jsx(Xe,{})})})},J=()=>{const[t,n]=l.useState(null),[i,o]=l.useState(null),s="https://highdardata.xyz/office/v1/account/customerData";return l.useEffect(()=>{(async()=>{try{const r=localStorage.getItem("accessToken"),c=await fetch(s,{headers:{Authorization:`Bearer ${r}`}});if(c.ok){const h=await c.json();n(h)}else o("Failed to fetch customer data")}catch(r){console.error("An error occurred while fetching customer data:",r),o("An error occurred while fetching customer data")}})()},[]),{customerData:t,error:i}},fe="/assets/div-21edab81.png",tt=g.div`
  width: 100%;
  //.page_content {
  //  max-width: 1300px;
  //  padding: 0 20px;
...
`,ht=({setUserRole:t})=>{const n=G(),[i,o]=l.useState(!0);return l.useEffect(()=>{(async()=>{const a=localStorage.getItem("accessToken");if(a)try{const r=await fetch("https://highdardata.xyz/office/v1/account/me",{method:"POST",headers:{Authorization:`Bearer ${a}`}});if(r.ok){const c=await r.json();t(c.role),c.role==="Admin"?n("/admin/accounts"):c.role==="Customer"&&n("/customer/dashboard")}else console.error("Помилка при отриманні ролі:",r.status)}catch(r){console.error("Помилка при отриманні ролі:",r)}finally{o(!1)}else o(!1)})()},[t,n]),i?e.jsx("div",{children:"Loading..."}):e.jsx(dt,{children:e.jsxs("div",{className:"content",children:[e.jsxs("div",{className:"login-form",children:[e.jsx("h2",{className:"title",children:"Login"}),e.jsx(lt,{setUserRole:t})]}),e.jsx("div",{className:"image",children:e.jsx("img",{src:ct,alt:"img"})})]})})},pt=({children:t})=>e.jsxs("div",{children:[t,e.jsx(Z,{})]}),xt="/assets/logo-463e5278.svg",mt="/assets/accounts-db43b069.svg",be="/assets/customers-bb8122ef.svg",gt="/assets/dashboard-65e50592.svg",ut="/assets/transactions-9bb38487.svg",ft=g.div`
  max-width: 220px;
  height: fit-content;
  width: 100%;
  background: #fff;
...
`,we="/assets/dot-77adc4b9.svg",vt=({...t})=>{var d;const[n,i]=l.useState(!1),o=G(),s=l.useRef(null),a=()=>{i(u=>!u)},r=()=>{localStorage.removeItem("accessToken"),localStorage.removeItem("userRole"),o("/login")},c=u=>{s.current&&!s.current.contains(u.target)&&i(!1)};l.useEffect(()=>(document.addEventListener("click",c),()=>{document.removeEventListener("click",c)}),[]);const h=((d=t==null?void 0:t.firstName)==null?void 0:d.charAt(0).toUpperCase())||"";return e.jsxs(bt,{className:"user",children:[e.jsxs("h5",{children:[t==null?void 0:t.firstName," ",t==null?void 0:t.lastName,"(",t==null?void 0:t.numericId,")"]}),e.jsx("span",{className:"user_avatar",children:h}),e.jsx("img",{className:"dots",ref:s,src:we,alt:"icon",onClick:a}),n&&e.jsx("div",{className:"get_out",onClick:r,children:"Get out"})]})},wt=g.div`
...
`,Ct=({children:t,setUserRole:n})=>{const{customerData:i,error:o}=J();return e.jsxs(wt,{children:[e.jsx(vt,{...i}),e.jsxs("div",{className:"page_content",children:[e.jsx(ve,{setUserRole:n}),t,e.jsx(Z,{})]})]})},Ft=g.div`
  height: 100px;
  display: flex;
  align-items: center;
  justify-content: flex-end;
...
`,At=({children:t,setUserRole:n})=>e.jsxs(kt,{children:[e.jsx(St,{}),e.jsxs("div",{className:"page_content",children:[e.jsx(ve,{setUserRole:n}),t,e.jsx(Z,{})]})]}),Nt=g.div`
    `,Et=g.div`
  border-radius: 10px;
  background: #FFF;
  box-shadow: 0px 10px 60px 0px rgba(10, 45, 97, 0.10);
  ...
  display: flex;
  flex-direction: column;
`,X=({children:t})=>e.jsx(Et,{children:t}),Ce="/assets/icon-1-116250cb.svg",Fe="/assets/icon-2-5b45725c.svg",Se="/assets/icon-3-010bf047.svg",ke="/assets/icon-4-1d64370f.svg",Tt="/assets/icon-5-be9637e6.svg",It="/assets/icon-6-b51c0dca.svg",zt=g.div`
...
`,Bt=({...t})=>e.jsx(Rt,{children:e.jsxs(X,{children:[e.jsx(Q,{...t}),e.jsx(Gt,{...t}),e.jsx(Lt,{...t})]})}),Mt=({setUserRole:t})=>{const{customerData:n,error:i}=J(),o=G();return l.useEffect(()=>{const s=localStorage.getItem("accessToken"),a=localStorage.getItem("userRole");s||o("/login"),a!=="Customer"&&o("/login")},[o]),e.jsxs(Nt,{children:[e.jsx("div",{className:"transactions_content",children:e.jsx(Bt,{...n})}),i&&e.jsx("div",{className:"error-message",children:i})]})},_t=g.div`
...
`,Ot=({...t})=>e.jsxs($t,{className:"clients-portfolio",children:[e.jsx("h2",{children:"Statistics"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("img",{src:Ce,alt:""}),e.jsx("h3",{children:"Total Clients:"}),t.totalClients]}),e.jsxs("li",{children:[e.jsx("img",{src:Fe,alt:""}),e.jsx("h3",{children:"Successful Cases:"}),t.successfulCases]}),e.jsxs("li",{children:[e.jsx("img",{src:Se,alt:""}),e.jsx("h3",{children:"Amount recovered:"}),t.amountRecovered]}),e.jsxs("li",{children:[e.jsx("img",{src:ke,alt:""}),e.jsx("h3",{children:"Personal Manager:"}),t.personalManager]})]})]}),Ut=g.div`
  position: relative;
...
`,M="/assets/bitcoin-bd99f642.svg",_="/assets/usdt-412d172a.svg",$="/assets/ethereum-4aa2070f.svg",O="/assets/litecoin-b3e4d598.svg",xn=({onSave:t,onClose:n,onCreate:i,editAssetData:o})=>{const[s,a]=l.useState({id:o==null?void 0:o.id,name:(o==null?void 0:o.name)||"",amount:(o==null?void 0:o.amount)||"",price:(o==null?void 0:o.price)||"",logoName:(o==null?void 0:o.logoName)||""}),r=h=>{const{name:d,value:u}=h.target;a(m=>({...m,[d]:u}))},c=async()=>{try{const h=localStorage.getItem("accessToken"),d=await fetch("https://highdardata.xyz/office/v1/assets/update",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${h}`},body:JSON.stringify(s)});d.ok?(console.log("Asset successfully updated"),t(),n()):console.error("Error updating asset:",d.statusText)}catch(h){console.error("Error updating asset:",h)}};return e.jsx(pn,{children:e.jsxs("div",{className:"modal-content",children:[e.jsxs("div",{className:"edit-assets-modal-fields",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"name",children:"Name"}),e.jsx("input",{type:"text",id:"name",name:"name",value:s.name,onChange:r})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"amount",children:"Amount"}),e.jsx("input",{type:"text",id:"amount",name:"amount",value:s.amount,onChange:r})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"price",children:"Price"}),e.jsx("input",{type:"text",id:"price",name:"price",value:s.price,onChange:r})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"logoName",children:"Logo"}),e.jsxs("div",{className:"custom-select",children:[e.jsxs("div",{className:"selected-option",onClick:()=>document.getElementById("options").classList.toggle("show"),children:[e.jsx("img",{src:s.logoName==="bitcoin.svg"?M:s.logoName==="usdt.svg"?_:s.logoName==="ethereum.svg"?$:s.logoName==="litecoin.svg"?O:"",alt:s.logoName,width:"25",height:"25"}),e.jsx("img",{className:"arr",src:W,alt:"arr",width:"15",height:"10"})]}),e.jsxs("div",{id:"options",className:"options",children:[e.jsx("div",{onClick:()=>{r({target:{name:"logoName",value:"bitcoin.svg"}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:M,alt:"Bitcoin",width:"25",height:"25"})}),e.jsx("div",{onClick:()=>{r({target:{name:"logoName",value:"usdt.svg"}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:_,alt:"Tether",width:"25",height:"25"})}),e.jsx("div",{onClick:()=>{r({target:{name:"logoName",value:"ethereum.svg"}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:$,alt:"Ethereum",width:"25",height:"25"})}),e.jsx("div",{onClick:()=>{r({target:{name:"logoName",value:"litecoin.svg"}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:O,alt:"Litecoin",width:"25",height:"25"})})]})]})]})]}),e.jsx("button",{onClick:c,children:"Save"})]})})},mn=g("div")`
...
`,gn=t=>{const[n,i]=l.useState(null),o=async()=>{try{const s=localStorage.getItem("accessToken"),a=await fetch(`https://highdardata.xyz/office/v1/customers/getSingle?id=${t}`,{headers:{Authorization:`Bearer ${s}`}});if(a.ok){const r=await a.json();i(r)}else console.error("Error fetching customer data:",a.statusText)}catch(s){console.error("Error fetching customer data:",s)}};return l.useEffect(()=>(t&&(o(),console.log("дані оновлено")),()=>{}),[t]),{customerData:n,fetchData:o}},un=({isOpen:t,onClose:n,onCreate:i})=>{const s=new URLSearchParams(window.location.search).get("id"),{customerData:a,fetchData:r}=gn(s),[c,h]=l.useState({customerId:s,name:"",amount:"",price:"",logoName:"bitcoin.svg"}),d=m=>{const{name:j,value:p}=m.target;h({...c,[j]:p})},u=async()=>{try{const m=localStorage.getItem("accessToken");(await fetch("https://highdardata.xyz/office/v1/assets/create",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${m}`},body:JSON.stringify(c)})).ok?(i(c),console.log("Asset created successfully!"),n(),r(),console.log("fetchData after create Asset ")):console.error("Помилка при відправці даних на сервер")}catch(m){console.error("Помилка:",m)}};return t?e.jsx(mn,{children:e.jsxs("div",{className:"modal-content",children:[e.jsxs("div",{className:"create-assets-modal-fields",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"name",children:"Name"}),e.jsx("input",{type:"text",name:"name",value:c.name,onChange:d})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"amount",children:"Amount"}),e.jsx("input",{type:"text",name:"amount",value:c.amount,onChange:d})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"price",children:"Price"}),e.jsx("input",{type:"text",name:"price",value:c.price,onChange:d})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"logoName",children:"Logo"}),e.jsxs("div",{className:"custom-select",children:[e.jsxs("div",{className:"selected-option",onClick:()=>document.getElementById("options").classList.toggle("show"),children:[e.jsx("img",{src:c.logoName==="bitcoin.svg"?M:c.logoName==="usdt.svg"?_:c.logoName==="ethereum.svg"?$:c.logoName==="litecoin.svg"?O:"",alt:c.logoName,width:"25",height:"25"}),e.jsx("img",{className:"arr",src:W,alt:"arr",width:"15",height:"10"})]}),e.jsxs("div",{id:"options",className:"options",children:[e.jsx("div",{onClick:()=>{d({target:{name:"logoName",value:"bitcoin.svg"}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:M,alt:"Bitcoin",width:"25",height:"25"})}),e.jsx("div",{onClick:()=>{d({target:{name:"logoName",value:"usdt.svg"}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:_,alt:"Tether",width:"25",height:"25"})}),e.jsx("div",{onClick:()=>{d({target:{name:"logoName",value:"ethereum.svg"}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:$,alt:"Ethereum",width:"25",height:"25"})}),e.jsx("div",{onClick:()=>{d({target:{name:"logoName",value:"litecoin.svg"}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:O,alt:"Litecoin",width:"25",height:"25"})})]})]})]})]}),e.jsx("button",{onClick:u,children:"Save"})]})}):null},fn=t=>{const[n,i]=l.useState(null),o=async()=>{try{const s=localStorage.getItem("accessToken"),a=await fetch(`https://highdardata.xyz/office/v1/customers/getSingle?id=${t}`,{headers:{Authorization:`Bearer ${s}`}});if(a.ok){const r=await a.json();i(r)}else console.error("Error fetching customer data:",a.statusText)}catch(s){console.error("Error fetching customer data:",s)}};return l.useEffect(()=>(t&&(o(),console.log("дані оновлено")),()=>{}),[t]),{customerData:n,fetchData:o}},jn=({isAssetCreateModalOpen:t,setIsAssetCreateModalOpen:n,onCreate:i})=>{const[o,s]=l.useState(null),a="/src/assets/images/cryptoIcon/",c=new URLSearchParams(window.location.search).get("id"),{customerData:h,fetchData:d}=fn(c),u=(h==null?void 0:h.assets)||[],m=async x=>{console.log(x);try{const w=localStorage.getItem("accessToken");(await fetch(`https://highdardata.xyz/office/v1/assets/delete?id=${x}`,{headers:{Authorization:`Bearer ${w}`}})).ok?(console.log("Asset successfully deleted"),await d(),console.log("after fetchData")):s("Error deleting asset")}catch{s("Error deleting asset")}},[j,p]=l.useState(!1),[k,y]=l.useState(null),v=()=>{p(!1)},F=x=>{y(x)},f=x=>{const w=u.find(C=>C.id===x);F(w),p(!0)},N=x=>{d(),n(!1)};return e.jsxs(hn,{children:[e.jsx("div",{className:"table-info",children:e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Name"}),e.jsx("th",{children:"Amount"}),e.jsx("th",{children:"Price"}),e.jsx("th",{children:"Logo"}),e.jsx("th",{}),e.jsx("th",{})]})}),e.jsx("tbody",{children:u.map(x=>e.jsxs("tr",{children:[e.jsx("td",{children:x.name}),e.jsx("td",{children:x.amount}),e.jsx("td",{children:x.price}),e.jsx("td",{children:e.jsx("img",{className:"coin-icon",src:`${a}${x.logoName}`,alt:""})}),e.jsx("td",{children:e.jsx("img",{className:"edit",src:U,alt:"icon",onClick:()=>{f(x.id)}})}),e.jsx("td",{children:e.jsx("img",{className:"bin",src:D,alt:"icon",onClick:()=>m(x.id)})})]},x.id))})]})}),e.jsx("div",{className:"assets_charts-doughnut",children:e.jsx(ye,{...h})}),j&&e.jsx(L,{isOpen:p,onClose:()=>p(!1),children:e.jsx(xn,{onSave:d,isOpen:j,onClose:v,onCreate:f,editAssetData:k})}),t&&e.jsx(L,{isOpen:n,onClose:()=>n(!1),children:e.jsx(un,{isOpen:t,onClose:()=>n(!1),onCreate:N})})]})},yn=g.div`
  table {
    width: 100%;
    border-collapse: collapse;
    margin-bottom: 10px;
...
`,te="/assets/success-0debd005.svg",ne="/assets/fail-a89a2289.svg",se="/assets/inprogress-f8857004.svg",H="/assets/new-ab67c1c6.svg",vn=({onSave:t,onClose:n,onCreate:i,editTransactionData:o})=>{const[s,a]=l.useState({id:o==null?void 0:o.id,numericId:o==null?void 0:o.numericId,name:(o==null?void 0:o.name)||"",status:(o==null?void 0:o.status)||"1",statusFormatted:(o==null?void 0:o.statusFormatted)||"",description:(o==null?void 0:o.description)||"",country:(o==null?void 0:o.country)||"",recoveredAmount:(o==null?void 0:o.recoveredAmount)||"",date:(o==null?void 0:o.date)||""}),r=h=>{const{name:d,value:u}=h.target;a(m=>({...m,[d]:u}))},c=async()=>{try{const h=localStorage.getItem("accessToken"),d=await fetch("https://highdardata.xyz/office/v1/transactions/update",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${h}`},body:JSON.stringify(s)});d.ok?(console.log("Asset successfully updated"),t(),n()):console.error("Error updating asset:",d.statusText)}catch(h){console.error("Error updating asset:",h)}};return e.jsx(bn,{children:e.jsxs("div",{className:"modal-content",children:[e.jsxs("div",{className:"edit-all-transaction-modal-fields",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"numericId",children:"Transaction ID"}),e.jsx("input",{type:"text",id:"numericId",name:"numericId",value:s.numericId,onChange:r})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"name",children:"Name"}),e.jsx("input",{type:"text",id:"name",name:"name",value:s.name,onChange:r})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"status",children:"Status"}),e.jsxs("div",{className:"custom-select",children:[e.jsxs("div",{className:"selected-option",onClick:()=>document.getElementById("options").classList.toggle("show"),children:[e.jsx("img",{src:s.status===1?se:s.status===2?te:s.status===3?ne:(s.status===4,H),alt:s.statusFormatted,width:"25",height:"25"}),e.jsx("img",{className:"arr",src:W,alt:"arr",width:"15",height:"10"})]}),e.jsxs("div",{id:"options",className:"options",children:[e.jsx("div",{onClick:()=>{r({target:{name:"status",value:1}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:se,alt:"inprogress",width:"25",height:"25"})}),e.jsx("div",{onClick:()=>{r({target:{name:"status",value:2}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:te,alt:"success",width:"25",height:"25"})}),e.jsx("div",{onClick:()=>{r({target:{name:"status",value:3}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:ne,alt:"fail",width:"25",height:"25"})}),e.jsx("div",{onClick:()=>{r({target:{name:"status",value:4}}),document.getElementById("options").classList.remove("show")},children:e.jsx("img",{src:H,alt:"newst",width:"25",height:"25"})})]})]})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"description",children:"Description"}),e.jsx("input",{type:"text",id:"description",name:"description",value:s.description,onChange:r})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"country",children:"Country"}),e.jsx("input",{type:"text",id:"country",name:"country",value:s.country,onChange:r})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"recoveredAmount",children:"Recovered Amount"}),e.jsx("input",{type:"text",id:"recoveredAmount",name:"recoveredAmount",value:s.recoveredAmount,onChange:r})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"date",children:"Date"}),e.jsx("input",{type:"text",id:"date",name:"date",value:s.date,onChange:r})]})]}),e.jsx("button",{onClick:c,children:"Save"})]})})},wn=g("div")`
...
`;const En=()=>{const[t,n]=l.useState(null),i=Be([{path:"/",element:e.jsx(pt,{}),children:[{path:"login",element:e.jsx(ht,{setUserRole:n})}]},{path:"admin",element:e.jsx(At,{}),children:[{path:"accounts",element:e.jsx(et,{})},{path:"customers",element:e.jsx(sn,{})},{path:"customer",element:e.jsx(Nn,{})}]},{path:"customer",element:e.jsx(Ct,{setUserRole:n}),children:[{path:"dashboard",element:e.jsx(rt,{})},{path:"transactions",element:e.jsx(Mt,{})},{path:"customers",element:e.jsx(Dt,{})}]},{path:"*",element:e.jsx(he,{to:"/",replace:!0})}]);return e.jsx(oe.StrictMode,{children:e.jsx(Me,{router:i})})};const Tn=()=>e.jsx(_e,{children:e.jsx(En,{})});ze.createRoot(document.getElementById("root")).render(e.jsx(oe.StrictMode,{children:e.jsx(Tn,{})}));
